...
import FadeLeftWrapper from "../../component/FadeLeftWrapper";
import FadeRightWrapper from "../../component/FadeRightWrapper";
  ...
  return (
    <div id="/" className="landing-container">
      ...
      <section className="content justify-center lg:mt-8">
        ...
        <FadeRightWrapper delay={0.1}>
          <div className="lg:mr-[1.5vw] lg:block hidden">
            <ProfileCard
              name="Truong Q.Tuong"
              title="Front-end Dev"
              handle="Tuong"
